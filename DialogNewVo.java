...
public class DialogNewVo extends JDialog implements ActionListener{
	...
	DialogVoGroup vg;// = new DialogVoGroup(this, "단어 그룹");
	String vocabulary, meaning;
	public DialogNewVo(Frame owner, String title) {
		super(owner, title);
		init();
